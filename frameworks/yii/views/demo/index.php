...
<?php require(__DIR__ . '/menu.php') ?>
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                <h3 class="page-header">Jaxon Yii Module</h3>

                <div class="row">
                    <div class="col-sm-6 col-md-6 text">
<p>
This example shows the usage of the Jaxon module for the Yii framework.
</p>
<p>
...
<p>
Install the Yii framework, version 3.0 or above.
</p>
<p>
Add the jaxon-core, jaxon-laravel and any other plugin package in the composer.json file, and run composer update.
</p>
<p>
Copy the content of the "app" dir in the jaxon-laravel package in the "application" dir of the Yii install.<br/>
This directory contains the Jaxon library for Yii, the config file and a controller to process Jaxon request.
</p>
<p>
