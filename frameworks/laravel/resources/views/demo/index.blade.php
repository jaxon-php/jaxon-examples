                ...
                <div class="row" id="jaxon-html">
                        ...
                        <div class="col-md-4 margin-vert-10">
                            <select class="form-control" id="colorselect1" name="colorselect1"
                                    onchange="{!! $pgw->setColor($jxn->select('colorselect1')) !!}; return false;">
                        ...
                        <div class="col-md-4 margin-vert-10">
                            <select class="form-control" id="colorselect2" name="colorselect2"
                                    onchange="{!! $bts->setColor($jxn->select('colorselect2')) !!}; return false;">
                                <option value="black" selected="selected">Black</option>
                                <option value="red">Red</option>
                                <option value="green">Green</option>
                                <option value="blue">Blue</option>
...
<script type='text/javascript'>
    ...
    window.onload = function() {
        ...
        {!! $pgw->setColor($jxn->select('colorselect1'), false) !!};
        // Call the HelloWorld class to populate the 2nd div
        {!! $bts->sayHello(0, false) !!};
        // call the HelloWorld->setColor() method on load
        {!! $bts->setColor($jxn->select('colorselect2'), false) !!};
    }
    /* ]]> */
</script>
</div>
